      ...
      >
        ...
        <b-form-group label="Name:">
          <b-form-input
            ...
            :state="!$v.ingredient.name.$invalid"
          ></b-form-input>
        </b-form-group>
        ...
        <b-form-group label="Protein:">
          <b-form-input
            ...
            :state="!$v.ingredient.protein.$invalid"
          ></b-form-input>
        </b-form-group>
        ...
        <b-form-group label="Fat:">
          <b-form-input
            ...
            :state="!$v.ingredient.fat.$invalid"
          ></b-form-input>
        </b-form-group>
        ...
        <b-form-group label="Carbonhydrate:">
          <b-form-input
            type="text"
            v-model="ingredient.carbonhydrate"
            :state="!$v.ingredient.carbonhydrate.$invalid"
          ></b-form-input>
        </b-form-group>
        ...
        <b-form-group label="Energy:">
          <b-form-input
            ...
            :state="!$v.ingredient.energy.$invalid"
          ></b-form-input>
        </b-form-group>
